...
- There are sections where it is assumed that the user will input data which falls within certain bounds. I need to
  enforce and check those bounds.
    - Default argument length and default line length need to both be reasonable and enforced.
- I need to audit the code for use after frees and off by ones. They don't happen within the parameters of codecrafters
  or my testing, but I need to test it more.
